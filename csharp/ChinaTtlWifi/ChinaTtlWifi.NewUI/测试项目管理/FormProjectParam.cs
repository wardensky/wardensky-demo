...
{
    public partial class FormProjectParam : FormBase
    {
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            if (isModify && this.project != null)
            {
                this.project.CaseList.Where(s => s.Id == this.testCase.Id).FirstOrDefault().StepList.Where(p => p.Id == this.step.Id).FirstOrDefault().Params.ParamList.RemoveAll(p => p.Id == this.Entity.Id);
            }
        ...
        {
            this.isModify = true;
            FormProjectParamNew form = new FormProjectParamNew();
